...
public class Mensual extends JInternalFrame implements ActionListener
{
    ...
    private JLabel lblT = new JLabel("Tiempo ( meses ):");
 ...
 if(interes.isSelected() == true)
	 {   	 
             por = Float.parseFloat(txtp.getText());
				 ...
				 mes = Float.parseFloat(txtt.getText());
...
if(capital.isSelected() == true)
    ...
    if(tiempo.isSelected() == true)
    		 { 
		        ...
		        {     por /= 100;
					 mes = round(inter/(cap*por));
				    lblR.setText("Respuesta: Su período es de "+mes+ "meses");
                }
           }
       }
