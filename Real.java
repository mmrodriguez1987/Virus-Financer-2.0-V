...
public class Real extends JInternalFrame implements ActionListener
{
    ...
    if(tiempo.isSelected() == true)
	      ...
	      double day2,año;
				 ...
				 else
		         {
				     ...
				     dia = Math.round(dia);
				     day2= round(dia/365);
				     lblR.setText("Respuesta: Total de años: "+day2+" ;  días: "+dia);
                 }
             }
       }
       catch(Exception g)
          {
	       JOptionPane.showMessageDialog(null,"Complete todos los datos","Error de lectura de datos",JOptionPane.ERROR_MESSAGE,new ImageIcon("Imagenes/help.gif"));
	       }
       }
