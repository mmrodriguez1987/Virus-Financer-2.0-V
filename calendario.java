...
public class calendario extends JInternalFrame implements ActionListener {
  ...
  super("Calendario");
    ...
    try{
		...
		anterior = new JButton("<< Anterior",new ImageIcon("Imagenes/2.jpg"));
		anterior.addActionListener(this);
		anterior.setMnemonic('A');
		anterior.setToolTipText("Mostrar el mes anterior");

		siguiente = new JButton("Siguiente >>",new ImageIcon("Imagenes/1.jpg"));
		siguiente.addActionListener(this);
		siguiente.setMnemonic('S');
		siguiente.setToolTipText("Mostrar el mes siguiente");

		ir = new JButton("Ir a...",new ImageIcon("Imagenes/ir.jpg"));
		ir.addActionListener(this);
		ir.setMnemonic('I');
		ir.setToolTipText("Escoger un mes o ver el mes actual");

		recordatorio = new JButton("Recordatorio",new ImageIcon("Imagenes/reco.jpg"));
